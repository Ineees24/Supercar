...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 20 sep. 2024 à 07:20
...
(2, 'Explorez notre vaste gamme de voitures neuves et de ', 'https://seversbreeman.nl/app/uploads/2022/05/P90461762_highRes_the-new-bmw-m4-csl-n-scaled-e1653039140695.jpg', ''),
...
(2, 'aly.kama', 'Aly', 'Kamar', 'kamrdine@gmail.com', 55123456, '$2y$10$/neaMlJyVSxTSx/hoD4Eoem3h2Uh3q/HThwsq0k1lPclDKNQoeCDa'),
(3, 'steav', 'SO', 'Ste', 'stea@gmail.com', 123456789, '$2y$10$zGzWmRqBHopMQFIwfLDXAeoGUCqQuYSEO.cW/GUr06..FSDPZTmL6'),
(4, 'steavpr', 'SORAYA', 'Stea', 'steal@gmail.com', 123456789, '$2y$10$X4PR1JGzaSAalq7yOTKqbeYCzBK6UxpRjmUoSsUgNiWnrDa49TVwW'),
(5, 'doda@gma', 'Jarrel', 'Dadou', 'dodajulie@gmail.com', 320262530, '$2y$10$.612.y80fHf1jvxoEfzB8O/eDHs0X1X.ui6KFwzijif91YIJ1smT6');
...
(7, 'M3', 'Jackie', '2024-05-02', '15:16:00', 'En attente'),
(8, 'MUSTANG', 'Vandam', '2024-05-12', '10:33:00', 'En attente'),
(9, 'X6M', 'Steavens', '2024-06-01', '13:56:00', 'Confirmé');
...
('BMW-M3', 'BMW', 'M3', 4, 1800, 1400, 1200, 900, 100, 2500000, 'essence', 87, 'BMW M3', '/supercar/img/BMW/m3.png'),
('BMW-M4', 'BMW', 'M4', 4, 1800, 1400, 1200, 900, 100, 97000, 'essence', 87, 'BMW M4', '/supercar/img/BMW/m44.png'),
('BMW-M8', 'BMW', 'M8', 5, 1800, 1400, 1200, 900, 100, 127500, 'essence', 87, 'BMW M8', '/supercar/img/BMW/m8bg.png'),
('BMW-X6M', 'BMW', 'X6M', 4, 1800, 1400, 1200, 900, 100, 101000, 'essence', 87, 'BMW X6M', '/supercar/img/BMW/m44.png'),
('FORD-FIESTA', 'FORD', 'FIESTA', 5, 1800, 1400, 1200, 900, 100, 44500, 'essence', 87, 'FORD FIESTA', '/supercar/img/ford/fiesta-bn-2.png'),
('FORD-GT', 'FORD', 'GT', 2, 1800, 1400, 1200, 900, 100, 120000, 'essence', 87, 'FORD GT', '/supercar/img/ford/HOR_XB1_Ford_GT_17.webp'),
('FORD-MUSTANG', 'FORD', 'MUSTANG', 4, 1800, 1400, 1200, 900, 100, 140000, 'essence', 87, 'FORD MUSTANG', '/supercar/img/ford/MOT_XB1_Ford_Mustang_15.webp'),
('FORD-RAPTOR', 'FORD', 'RAPTOR', 5, 1800, 1400, 1200, 900, 100, 78750, 'diesel ', 87, 'FORD RAPTOR', '/supercar/img/ford/raptor-bn.png'),
('NISSAN-GTR', 'NISSAN', 'GT-R', 3, 1800, 1400, 1200, 900, 100, 107000, 'essence', 87, 'NISSAN GT-R', '/supercar/img/nissan/nissan-tr.png'),
('NISSAN-JESKO', 'NISSAN', 'JESKO', 5, 1800, 1400, 1200, 900, 100, 100000, 'essence', 87, 'NISSAN JESKO', '/supercar/img/nissan/juke-re.png'),
('NISSAN-NAVARA', 'NISSAN', 'NAVARA', 5, 1800, 1400, 1200, 900, 100, 93750, 'essence', 87, 'NISSAN NAVARA', '/supercar/img/nissan/navara-ar.png'),
...
('PORSCHE-TAYCAN', 'PORSCHE', 'TAYCAN', 5, 1800, 0, 1200, 900, 100, 187500, 'essence', 87, 'PORSCHE TAYCAN', '/supercar/img/Porsche/Taycan Turbo S');
COMMIT;
