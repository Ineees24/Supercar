...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 14 avr. 2025 à 23:02
...
INSERT INTO `client_inscrit` (`ID_client`, `Utilisateur`, `Nom`, `Prenom`, `Email`, `Tel`, `Mdp`, `derniere_connexion`) VALUES
(1, 'Vandam', 'Jean', 'Claude', 'vandam@gmail.com', 230328, 'jean1234', NULL),
(2, 'gase', 'ikari', 'yuura', 'ikari@gmail.com', 230328, '12345', NULL),
(4, 'han', 'han', 'sung', 'han@gmail.com', 8389445, '12345', NULL),
(5, 'Chan', 'Jackie', 'Chan', 'jackiechan@gmail.com', 230328, '12345', NULL),
(6, 'Bot', 'Bot', '1', 'bot@gmail.com', 230328, '8cb2237d0679ca88db6464eac60da96345513964', NULL),
(7, 'Vandame', 'Jackie', 'sung', 'bot@gmail.com', 230328, '8cb2237d0679ca88db6464eac60da96345513964', NULL),
(8, 'Chan', 'geogre', 'Claude', 'bot@gmail.com', 230328, '8cb2237d0679ca88db6464eac60da96345513964', NULL),
(9, 'Bot', 'Jackie', 'Claude', 'bot@gmail.com', 0, '8cb2237d0679ca88db6464eac60da96345513964', NULL),
(10, 'client', 'Client', 'client', 'client@gmail.com', 12345, '8a617f3b33b922b6ec078e067407eeb6f693aaab', '2025-04-15 02:57:44'),
(11, 'InesZ', 'Ines', 'Z', 'ines@gmail.com', 1234, 'fd4bf593ac92e69360db4c9cf94cc00c68a2152b', '2025-02-18 18:14:13');

--
-- Déclencheurs `client_inscrit`
--
DROP TRIGGER IF EXISTS `update_last_login`;
DELIMITER $$
CREATE TRIGGER `update_last_login` BEFORE UPDATE ON `client_inscrit` FOR EACH ROW BEGIN
